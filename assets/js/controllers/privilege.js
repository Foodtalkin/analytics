...
// create calls
            ...
            $scope.getOutletRedeemedReport = function () {
                angular.forEach($scope.RestaurantData.outlet, function (key, value) {
                    privilegeFact.getOutletRedeemedReport(key.id, function (response) {
                        $scope.RestaurantData.outlet[value].Redeemed = []
                        $scope.RestaurantData.outlets[value].Redeemed = []
    ...
    .factory('privilegeFact', ['$http', 'UrlFact', function ($http, UrlFact) {
        ...
        privilegeFact.getOutletRedeemedReport = function (id, callback) {
            $http({
                method: 'GET',
                url: UrlFact.privilege.outletRedeemedReport + '/' + id,
            }).then(function (response) {
                callback(response)
            })
        }
